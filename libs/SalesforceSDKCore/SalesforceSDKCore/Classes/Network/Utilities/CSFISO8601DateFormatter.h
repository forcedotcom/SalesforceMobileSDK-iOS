 ...
 */
enum {
	CSFISO8601DateFormatCalendar,
	CSFISO8601DateFormatOrdinal,
	CSFISO8601DateFormatWeek,
};
typedef NSUInteger CSFISO8601DateFormat;

//The default separator for time values. Currently, this is ':'.
extern unichar CSFISO8601DateDefaultTimeSeparatorCharacter;

@interface CSFISO8601DateFormatter: NSFormatter
...
@property (nonatomic, assign) CSFISO8601DateFormat format;
