...
$SCRIPT_DIR/build-ios.sh -c Debug -b $WORKSPACE/derivedData -f SalesforceHybridSDK -g SalesforceHybridSDKCordovaPlugin
$SCRIPT_DIR/build-ios.sh -c Release -b $WORKSPACE/derivedData -f SalesforceHybridSDK -g SalesforceHybridSDKCordovaPlugin
