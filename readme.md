...
The Salesforce Mobile SDK for iOS requires iOS 18.0 or greater.  The install.sh script checks for this, and aborts if the configured SDK version is incorrect.
