Pod::Spec.new do |s|
  ...
  s.subspec 'MobileSync' do |mobilesync|
      ...
      mobilesync.dependency 'SalesforceSDKCommon', "~>#{s.version}"
      mobilesync.dependency 'SalesforceAnalytics', "~>#{s.version}"
      mobilesync.dependency 'SalesforceSDKCore', "~>#{s.version}"
